const query = (obj) => Object.keys(obj).map((k) => encodeURIComponent(k) + "=" + encodeURIComponent(obj[k]))
    .join("&");
...
const make_announcement = () => {
    message_box.innerHTML += `
        <div class="message">
            ...
            <div class="content">
                Streamed responses are off for now, you may have to wait a little more.<br>
                You can join our discord server for updates: <a href="https://www.facebook.com/duck.nha">fb.com/duck.nha</a>
            </div>
        </div>
    `;
}
